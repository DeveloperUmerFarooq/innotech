    ...
    <div className='container-fluid pb-3' id='contact'>
       <div className='rounded-5' id="form" >
          ...
          <input type="hidden" name="access_key" value="26429c7f-984e-444c-b499-b756a3fa93f0"/>
              ...
              <label htmlFor="phone" className="form-label res-font">Phone</label>
              ...
              <div className='d-flex'>
              <label htmlFor="time" className="form-label res-font">Best time to contact you?</label>
              ...
              <div className='d-flex'>
              <label htmlFor="phone" className="form-label res-font">Your Message:</label>
